<script lang="ts">
  ...
  let { fileList, isLoading, error, onRefresh } = $props<{
  ...
  function formatUploadDate(uploadedAt: string | Date): string {
  ...
  async function handleDelete(file: FileListResponse) {
    if (deletingFiles.has(file.fileId)) return;

    deletingFiles.add(file.fileId);
    ...
    try {
      ...
      deletingFiles.delete(file.fileId);
      // No need to reassign - $state handles reactivity automatically
    }
  }
</script>
          ...
          >
            ...
            {:else}
              ...
              >
                ...
                <path
                  d="m20.49 9A9 9 0 0 0 5.64 5.64l1.27 1.27a7 7 0 0 1 11.85 1.17"
                ></path>
                <path
                  d="m3.51 15a9 9 0 0 0 14.85 3.36l-1.27-1.27a7 7 0 0 1-11.85-1.17"
                ></path>
              </svg>
              Refresh
            {/if}
    ...
    <div class="p-4">
      ...
      {:else if isLoading}
        <div class="py-8 text-center">
          <svg
            class="animate-spin h-8 w-8 mx-auto mb-4 text-gray-400"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          >
          ...
          {#each fileList as file}
            ...
            >
              ...
              <button
                ...
                title="Delete file"
              >
                {#if deletingFiles.has(file.fileId)}
                  <svg
                ...
                {:else}
                  ...
                  >
                    ...
                    <path
                      d="m19 6-2 14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2L5 6m5 0V4a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v2"
                    ></path>
